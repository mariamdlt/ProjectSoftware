...
<body class="skin-red fixed">
  <div class="wrapper">
    ...
    <header class="main-header">
      <!-- Logo -->
      <a href="?module=home" class="logo"><b>Administración </b>Hotel</a>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        <ul class="sidebar-menu">
          ...
          <li class="active">
            <a href="modules/home"><i class="fa fa-home"></i> Inicio </a>
          </li>

          <li class="active">
            <a href=""><i class="fa fa-pencil"></i> Crear Nueva Habitación</a>
          </li>
  ...
  <div class="row">
    <div class="col-md-12">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($con, "SELECT * FROM habitacion ORDER BY HABI_ID DESC")
            ...
            while ($data = mysqli_fetch_assoc($query)) {
              ...
              echo "<tr>
                      ...
                      <td width='20'>$data[ESTA_ID]</td>
                      <td width='20'>$data[HABI_NOMBRE]</td>
                      <td width='70'>$data[HABI_SERVICIOS]</td>
                      <td width='10'>$data[HABI_NACAMAS]</td>
                      <td class='center' width='40'>
                      <div>
                          <a data-toggle='tooltip' data-placement='top' title='Editar' style='margin-right:5px' class='btn btn-primary btn-sm' href=''>
                              <i style='color:#fff' class='glyphicon glyphicon-edit'></i>
                          </a>";
            ?>

            <a data-toggle="tooltip" data-placement="top" title="Eliminar" class="btn btn-danger btn-sm" href="" onclick="return confirm('Estas seguro que quieres eliminar <?php  ?> ?');">
