            ...
            <div class="box box-primary">
              ...
              <form role="form" class="form-horizontal">
                <?php
                  ...
                  if(isset($_POST['save']))
                  {
                    $estadoid = $_POST['cbnEstado'];
                    $nombres = $_POST['txtNombre'];
                    $sevicios = $_POST['txtServicios'];
                    $camas = $_POST['txtCamas'];

                    $res=mysql_query($con,"INSERT INTO habitacion(ESTA_ID,
                      HABI_NOMBRE, HABI_SERVICIOS, HABI_NCAMAS)

                    VALUES('$estadoid','$nombres','$sevicios','$camas')") or die('Hubo un error en la insercion de los datos: '.mysqli_error($con));
                    //$res=$con->insertaHabitacion($estadoid,$nombres,$sevicios,$camas);
                    if($res)
                    {
                ?>
                <script>
                  ...
                  ?>
                  <script>
                    alert('Error al Grabar Registro...!!!');
                    window.location='view.php'
                  </script>
                  <?php
                    }
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="txtServicios" autocomplete="off" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="txtCamas" autocomplete="off" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <select name="cbnEstado" id="cbnEstado">
                ...
                <div class="box-footer">
                  <div class="form-group">
                    <div class="col-sm-offset-1 col-sm-11">
                      ...
                      <a href="view.php" class="btn btn-default btn-reset">Cancelar</a>
                    </div>
                  </div>
                </div><!-- /.box footer -->
              </form>
